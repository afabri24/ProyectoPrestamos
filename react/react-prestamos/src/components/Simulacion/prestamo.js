...
// function impresion() {
//     console.log(document.getElementById('monto'));    
// }


// var establecerDatos = function () {
//     primerInteres = 0, primerImpuesto = 0, primerCapital = 0, primerInsoluto = 0, primerFechaPago = true, acumIntereses = 0, acumImpuestos = 0, acumCapital = 0
